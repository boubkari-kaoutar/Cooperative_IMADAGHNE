...
export default function ContactPage() {
  ...
  const l = {
    ...
    h1a: t("contact.pageTitle1"),
    h1b: t("contact.pageTitle2"),
    sub: t("contact.pageSub"),
  ...
  return (
    <div ref={pageRef} style={{ background: "#FBF7F2", minHeight: "100vh", color: "#2B2B2B", fontFamily: "'Plus Jakarta Sans', sans-serif" }}>

      {/* ══ 1. HERO ═══════════════════════════════════════════ */}
      <section ref={heroRef} className="relative pt-24 pb-32 md:pb-40 overflow-hidden" style={{ background: "#0E3D1C", color: "#FBF7F2" }}>
        
        {/* Glow accents */}
        <div className="absolute top-0 right-0 w-[600px] h-[600px] rounded-full blur-[140px] opacity-20" style={{ background: "#529627", pointerEvents: "none" }} />
        <div className="absolute top-[-20%] left-[-10%] w-[500px] h-[500px] rounded-full opacity-10 blur-[120px]" style={{ background: "#895F37", pointerEvents: "none" }} />

        {/* Content */}
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 w-full text-center mt-0">

          <div className="hero-line inline-flex items-center gap-3 mb-6">
            <div className="w-8 h-px bg-[#529627]" />
            <span className="text-xs font-black uppercase tracking-[0.3em] text-[#529627]">{l.badge}</span>
            <div className="w-8 h-px bg-[#529627]" />
          </div>

          <h1 className="hero-line font-black leading-tight tracking-tight mx-auto max-w-4xl"
            style={{ fontSize: "clamp(48px, 6vw, 80px)", fontFamily: "'Playfair Display', serif" }}>
            <span className="text-white block">{l.h1a}</span>
            <span className="block text-[#529627] italic">{l.h1b}</span>
          </h1>

          <p className="hero-line mt-6 text-base md:text-lg leading-relaxed max-w-2xl mx-auto opacity-80"
        ...
        <div className="absolute bottom-[-1px] left-0 w-full overflow-hidden leading-[0]">
            <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none" className="relative block w-full h-[60px] md:h-[100px]">
                <path d="M321.39,56.44c58-10.79,114.16-30.13,172-41.86,82.39-16.72,168.19-17.73,250.45-.39C823.78,31,906.67,72,985.66,92.83c70.05,18.48,146.53,26.09,214.34,3V120H0V95.8C59.71,118.06,130.83,123.32,192.3,114.5,241.6,107.44,285.83,73.57,321.39,56.44Z" fill="#FBF7F2"></path>
            </svg>
        </div>
      </section>

      {/* ══ 2. INFO CARDS ═════════════════════════════════════ */}
      <div ref={cardsRef} className="max-w-7xl mx-auto px-6 lg:px-8 py-16 mt-[-40px] md:mt-[-60px] relative z-20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            ...
            <div className="lg:col-span-7">
              <div className="mb-10">
                ...
                <h2 className="font-black tracking-tight text-[#0E3D1C]" style={{ fontSize: "clamp(30px, 4vw, 46px)", fontFamily: "'Playfair Display', serif" }}>
                  {l.formTitle}
                </h2>
              </div>
              ...
              {status !== "success" && (
                <form ref={formRef} onSubmit={submit} className="flex flex-col gap-5">
                  ...
                  {/* Name + Email */}
                  <div className="ff grid grid-cols-1 md:grid-cols-2 gap-5">
                  ...
                  {/* Message */}
                  <div className="ff flex flex-col gap-2 relative">
                    <label className="text-xs font-bold uppercase tracking-wider text-[#895F37] ml-2">
            ...
            <div className="lg:col-span-5" ref={faqRef as React.RefObject<HTMLDivElement>}>
              <div className="mb-10">
                ...
                <h2 className="font-black tracking-tight text-[#0E3D1C]" style={{ fontSize: "clamp(26px, 3vw, 36px)", fontFamily: "'Playfair Display', serif" }}>
                  {l.faqTitle}
                </h2>
              </div>
